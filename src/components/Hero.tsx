...
>
  Sorab Hans
        ...
        {/* Portfolio Title */}
        <motion.h1
          className="relative text-6xl md:text-9xl lg:text-[12rem] font-extrabold text-white tracking-tight inline-block z-20"
          initial={{ scale: 0.8, opacity: 0 }}
          animate={{ scale: 1, opacity: 1 }}
          transition={{ duration: 1.3, delay: 0.5, ease: "easeOut" }}
        >
          ...
          <span className="relative inline-block mx-4 z-20">
            {/* Animated Glowing Orb */}
            <motion.span
              className="relative w-16 h-16 md:w-32 md:h-32 rounded-full bg-white shadow-[0_0_80px_30px_rgba(255,255,255,0.9)] inline-flex items-center justify-center z-20"
              animate={{
                scale: [1, 1.1, 1],
                boxShadow: [
                  "0 0 60px 25px rgba(255,255,255,0.7)",
